...
- **[Discord chat](https://discord.07ai.com)**: To chat with people [Discord chat](https://discord.07ai.com/) and a quicker feedback.
...
2. **Clone your fork:** Bring a copy of your fork to your local machine.
   ```bash
   git clone https://github.com/YOUR_USERNAME/07ai.git
   ```
...
Again, do check the [developer guide](https://docs.07ai.com/developer-guide). Much of what you probably need to know is in there.

If you encounter any issues, please visit our [support page](https://docs.07ai.com/support) or check the community forums. Your contributions help make 07ai better!
