import {
  ...
  PostResponse,
  SocialProvider,
} from '@07ai/nestjs-libraries/integrations/social/social.integrations.interface';
import { makeId } from '@07ai/nestjs-libraries/services/make.is';
import sharp from 'sharp';
import { lookup } from 'mime-types';
import { readOrFetch } from '@07ai/helpers/utils/read.or.fetch';
import { SocialAbstract } from '@07ai/nestjs-libraries/integrations/social.abstract';
import { Integration } from '@prisma/client';
import { PostPlug } from '@07ai/helpers/decorators/post.plug';
import { LinkedinDto } from '@07ai/nestjs-libraries/dtos/posts/providers-settings/linkedin.dto';
import imageToPDF from 'image-to-pdf';
import { Readable } from 'stream';
import { Rules } from '@07ai/nestjs-libraries/chat/rules.description.decorator';
