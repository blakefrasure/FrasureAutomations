import { RedditSettingsDto } from '@07ai/nestjs-libraries/dtos/posts/providers-settings/reddit.dto';
import { PinterestSettingsDto } from '@07ai/nestjs-libraries/dtos/posts/providers-settings/pinterest.dto';
import { YoutubeSettingsDto } from '@07ai/nestjs-libraries/dtos/posts/providers-settings/youtube.settings.dto';
import { TikTokDto } from '@07ai/nestjs-libraries/dtos/posts/providers-settings/tiktok.dto';
import { XDto } from '@07ai/nestjs-libraries/dtos/posts/providers-settings/x.dto';
import { LemmySettingsDto } from '@07ai/nestjs-libraries/dtos/posts/providers-settings/lemmy.dto';
import { DribbbleDto } from '@07ai/nestjs-libraries/dtos/posts/providers-settings/dribbble.dto';
import { DiscordDto } from '@07ai/nestjs-libraries/dtos/posts/providers-settings/discord.dto';
import { SlackDto } from '@07ai/nestjs-libraries/dtos/posts/providers-settings/slack.dto';
import { KickDto } from '@07ai/nestjs-libraries/dtos/posts/providers-settings/kick.dto';
import { TwitchDto } from '@07ai/nestjs-libraries/dtos/posts/providers-settings/twitch.dto';
import { InstagramDto } from '@07ai/nestjs-libraries/dtos/posts/providers-settings/instagram.dto';
import { LinkedinDto } from '@07ai/nestjs-libraries/dtos/posts/providers-settings/linkedin.dto';
...
import { HashnodeSettingsDto } from '@07ai/nestjs-libraries/dtos/posts/providers-settings/hashnode.settings.dto';
...
import { GmbSettingsDto } from '@07ai/nestjs-libraries/dtos/posts/providers-settings/gmb.settings.dto';
import { FarcasterDto } from '@07ai/nestjs-libraries/dtos/posts/providers-settings/farcaster.dto';
