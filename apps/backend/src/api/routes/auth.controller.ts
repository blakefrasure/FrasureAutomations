...
import { CreateOrgUserDto } from '@07ai/nestjs-libraries/dtos/auth/create.org.user.dto';
import { LoginUserDto } from '@07ai/nestjs-libraries/dtos/auth/login.user.dto';
import { AuthService } from '@07ai/backend/services/auth/auth.service';
import { ForgotReturnPasswordDto } from '@07ai/nestjs-libraries/dtos/auth/forgot-return.password.dto';
import { ForgotPasswordDto } from '@07ai/nestjs-libraries/dtos/auth/forgot.password.dto';
import { ResendActivationDto } from '@07ai/nestjs-libraries/dtos/auth/resend-activation.dto';
import { ApiTags } from '@nestjs/swagger';
import { getCookieUrlFromDomain } from '@07ai/helpers/subdomain/subdomain.management';
import { EmailService } from '@07ai/nestjs-libraries/services/email.service';
import { RealIP } from 'nestjs-real-ip';
import { UserAgent } from '@07ai/nestjs-libraries/user/user.agent';
...
export class AuthController {
  ...
  mobileCallback(
    ...
    const scheme = process.env.MOBILE_APP_SCHEME || '07ai://auth/callback';
