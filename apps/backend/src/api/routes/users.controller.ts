...
import { GetUserFromRequest } from '@07ai/nestjs-libraries/user/user.from.request';
...
import { EmailNotificationsDto } from '@07ai/nestjs-libraries/dtos/users/email-notifications.dto';
import { HttpForbiddenException } from '@07ai/nestjs-libraries/services/exception.filter';
