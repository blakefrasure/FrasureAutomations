...
import { CustomFileValidationPipe } from '@07ai/nestjs-libraries/upload/custom.upload.validation';
...
import { UploadFactory } from '@07ai/nestjs-libraries/upload/upload.factory';
import { MediaService } from '@07ai/nestjs-libraries/database/prisma/media/media.service';
import { GetPostsDto } from '@07ai/nestjs-libraries/dtos/posts/get.posts.dto';
import { ChangePostStatusDto } from '@07ai/nestjs-libraries/dtos/posts/change.post.status.dto';
import {
  AuthorizationActions,
  Sections,
} from '@07ai/backend/services/auth/permissions/permission.exception.class';
import { VideoDto } from '@07ai/nestjs-libraries/dtos/videos/video.dto';
import { VideoFunctionDto } from '@07ai/nestjs-libraries/dtos/videos/video.function.dto';
import { UploadDto } from '@07ai/nestjs-libraries/dtos/media/upload.dto';
import { NotificationService } from '@07ai/nestjs-libraries/database/prisma/notifications/notification.service';
import { GetNotificationsDto } from '@07ai/nestjs-libraries/dtos/notifications/get.notifications.dto';
...
import { socialIntegrationList, IntegrationManager } from '@07ai/nestjs-libraries/integrations/integration.manager';
import { getValidationSchemas } from '@07ai/nestjs-libraries/chat/validation.schemas.helper';
import { RefreshIntegrationService } from '@07ai/nestjs-libraries/integrations/refresh.integration.service';
import { RefreshToken } from '@07ai/nestjs-libraries/integrations/social.abstract';
