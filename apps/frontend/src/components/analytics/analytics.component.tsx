...
import { StarsAndForks } from '@07ai/frontend/components/analytics/stars.and.forks';
import { FC, useCallback } from 'react';
import { StarsTableComponent } from '@07ai/frontend/components/analytics/stars.table.component';
