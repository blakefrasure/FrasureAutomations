...
import { CheckIconComponent } from '@07ai/frontend/components/ui/check.icon.component';
import {
  FAQComponent,
  FAQSection,
} from '@07ai/frontend/components/billing/faq.component';
...
import { DeveloperIconComponent } from '@07ai/frontend/components/developer/developer.icon.component';
...
const EmbeddedBilling = dynamic(
  () =>
    import('@07ai/frontend/components/billing/embedded.billing').then(
...
export const FirstBillingComponent = () => {
  ...
  const showYouTube = () => {
    modals.openModal({
      title: 'Grow Fast With 07ai (Play the video)',
      children: (
        <iframe
    ...
    return (
      <>
        <div className="text-[46px] font-[600] leading-[110%] tablet:text-[36px] mobile:!text-[30px] whitespace-pre-line text-balance">
          ...
          {t(
            'billing_07ai_grow_social',
            '07ai To Grow Their Social Presence'
          )}
        </div>
        ...
        <div className="flex" onClick={showYouTube}>
          <div className="tablet:mb-[32px] cursor-pointer mt-[32px] flex gap-[10px] items-center underline hover:font-[700]">
            ...
            <div>See the power of 07ai (click here)</div>
          </div>
        </div>
