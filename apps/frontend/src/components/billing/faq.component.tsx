  ...
  return [
    ...(user?.allowTrial
      ? [
          {
            title: t(
              'faq_am_i_going_to_be_charged_by_07ai',
              'Am I going to be charged by 07ai?'
            ),
            description: t(
              'faq_to_confirm_credit_card_information_07ai_will_hold',
              'To confirm credit card information 07ai will hold $2 and release it immediately, you can cancel your subscription anytime from settings without talking to a person'
            ),
          },
        ]
      : []),
    {
      title: t(
        'faq_can_i_trust_07ai_07ai',
        `Can I trust ${isGeneral ? '07ai' : '07ai'}?`
      ),
      description: t(
        'faq_07ai_07ai_is_proudly_open_source',
        `${
          isGeneral ? '07ai' : '07ai'
        } is proudly open-source! We believe in an ethical and transparent culture, meaning that ${
          isGeneral ? '07ai' : '07ai'
        } will live forever. You can check out the entire code or use it for personal projects. To view the open-source repository, <a href="https://github.com/07aihq/07ai-app" target="_blank" style="text-decoration: underline;">click here</a>.`
      ),
    },
    {
      title: t('faq_what_are_channels', 'What are channels?'),
      description: t(
        'faq_07ai_07ai_allows_you_to_schedule_posts',
        `${
          isGeneral ? '07ai' : '07ai'
