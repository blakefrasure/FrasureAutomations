...
import { showMediaBox } from '@07ai/frontend/components/media/media.component';
import { useFetch } from '@07ai/helpers/utils/custom.fetch';
import { classValidatorResolver } from '@hookform/resolvers/class-validator';
import { UserDetailDto } from '@07ai/nestjs-libraries/dtos/users/user.details.dto';
import { useToaster } from '@07ai/react/toaster/toaster';
import { useSWRConfig } from 'swr';
import clsx from 'clsx';
import { TeamsComponent } from '@07ai/frontend/components/settings/teams.component';
import { useUser } from '@07ai/frontend/components/layout/user.context';
import { LogoutComponent } from '@07ai/frontend/components/layout/logout.component';
import { useSearchParams } from 'next/navigation';
import { useVariables } from '@07ai/react/helpers/variable.context';
import { PublicComponent } from '@07ai/frontend/components/public-api/public.component';
import Link from 'next/link';
import { Webhooks } from '@07ai/frontend/components/webhooks/webhooks';
import { Sets } from '@07ai/frontend/components/sets/sets';
import { SignaturesComponent } from '@07ai/frontend/components/settings/signatures.component';
import { Autopost } from '@07ai/frontend/components/autopost/autopost';
import { useT } from '@07ai/react/translation/get.transation.service.client';
import { SVGLine } from '@07ai/frontend/components/launches/launches.component';
import { GlobalSettings } from '@07ai/frontend/components/settings/global.settings';
import { ApprovedAppsComponent } from '@07ai/frontend/components/approved-apps/approved-apps.component';
