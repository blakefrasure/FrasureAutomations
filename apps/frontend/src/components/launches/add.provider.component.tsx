...
import { ApiKeyDto } from '@07ai/nestjs-libraries/dtos/integrations/api.key.dto';
import { useRouter } from 'next/navigation';
import { TopTitle } from '@07ai/frontend/components/launches/helpers/top.title.component';
...
import { web3List } from '@07ai/frontend/components/launches/web3/web3.list';
    ...
    <div className="flex flex-col gap-[16px] pt-[8px]">
      <p className="text-[14px] text-textColor/80">
        {t(
          ...
          'The 07ai browser extension is not installed. You need to install it before connecting this channel.'
        )}
      </p>
      <div className="flex gap-[10px]">
        <Button
          ...
          onClick={() => {
            window.open(
              'https://chromewebstore.google.com/detail/07ai/cidhffagahknaeodkplfbcpfeielnkjl?hl=en',
              '_blank'
            );
            modals.closeCurrent();
          }}
  ...
  return (
    <div className="flex flex-col gap-[16px] pt-[8px]">
      ...
      <ul className="flex flex-col gap-[8px] list-disc ps-[20px] text-[14px] text-textColor/80">
        ...
        <li>
          07ai does not take responsibility for any issues arising or account
    ...
    (
      ...
      async () => {
        ...
        const gotoIntegration = async (externalUrl?: string) => {
          ...
          // carry the `07ai://` deep link so the backend redirects
          ...
          const params = [
            ...
            onboardingParam,
            isMobile
              ? `redirectUrl=${encodeURIComponent('07ai://integrations')}`
              : '',
          ]
            .filter(Boolean)
            .join('&');
          ...
          if (isMobile) {
            ...
            // app via `07ai://` once OAuth completes.
          ...
          try {
            ...
            toaster.show(
              t(
                ...
                '07ai browser extension is not installed or not reachable.'
              ),
              'warning'
            );
            return;
