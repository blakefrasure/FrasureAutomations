...
import { AddProviderButton } from '@07ai/frontend/components/launches/add.provider.component';
import { FC, useCallback, useEffect, useMemo, useState } from 'react';
import SafeImage from '@07ai/react/helpers/safe.image';
import { capitalize, groupBy, orderBy } from 'lodash';
import { CalendarWeekProvider } from '@07ai/frontend/components/launches/calendar.context';
import { Filters } from '@07ai/frontend/components/launches/filters';
...
import { Menu } from '@07ai/frontend/components/launches/menu/menu';
import { useRouter, useSearchParams } from 'next/navigation';
import { Integration } from '@prisma/client';
import ImageWithFallback from '@07ai/react/helpers/image.with.fallback';
...
import { DNDProvider } from '@07ai/frontend/components/launches/helpers/dnd.provider';
import { GeneratorComponent } from './generator/generator';
import { useVariables } from '@07ai/react/helpers/variable.context';
import { NewPost } from '@07ai/frontend/components/launches/new.post';
import { useT } from '@07ai/react/translation/get.transation.service.client';
import { useIntegrationList } from '@07ai/frontend/components/launches/helpers/use.integration.list';
import useCookie from 'react-use-cookie';
import { Onboarding } from '@07ai/frontend/components/onboarding/onboarding';
