...
import { InstagramCollaboratorsTags } from '@07ai/frontend/components/new-launch/providers/instagram/instagram.tags';
import { useT } from '@07ai/react/translation/get.transation.service.client';
import { InstagramPreview } from '@07ai/frontend/components/new-launch/providers/instagram/instagram.preview';
const postType = [
  {
    value: 'post',
    label: 'Post / Reel',
