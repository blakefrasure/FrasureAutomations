...
# Copilot Coding Agent Instructions for 07ai
...
- SDK (`apps/sdk`) provides programmatic access to 07ai features.
...
## Documentation
- Main docs: https://docs.07ai.com/
- Developer guide: https://docs.07ai.com/developer-guide
- Public API: https://docs.07ai.com/public-api
